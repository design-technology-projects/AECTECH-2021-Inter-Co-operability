...
#pragma warning disable CS0649
        ...
        [SerializeField]
        ToolButton gr_AnalysisToolButton;
        [SerializeField]
        ToolButton gr_AnnotationsToolButton;
...
#pragma warning restore CS0649
        ...
        //MasterClass Grimshaw addition
        public void ClickSelectButton()
        { m_SelectButton.ClickIt(); }
        ...
        void OnStateDataChanged(UIStateData data)
        {
            if (m_ToolbarsEnabled != data.toolbarsEnabled)
            {
                ...
                gr_AnalysisToolButton.button.interactable = data.toolbarsEnabled;
                gr_AnnotationsToolButton.button.interactable = data.toolbarsEnabled;
