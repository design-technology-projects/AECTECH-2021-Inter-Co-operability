...
#pragma warning restore CS0649
        ...
        protected virtual void Awake()
        {
            ...
            //OrphanUIController.onPointerClick += CheckForAnnotation;
        }
        ...
        void CheckForAnnotation(BaseEventData data)
        {
            ...
            if (m_ObjectPicker!=null)
            {
                ...
                var found = m_Results.Select(x => x.Item1).Where(x => x.name == "Button_Image_Annotation").ToList();
                if (found.Count > 0)
                    found[0].GetComponent<UnityEngine.UI.Button>().onClick.Invoke();
            }
