...
public class projectListItem : MonoBehaviour
{
    ...
    //public AnnotationClientExample annot;
...
#pragma warning restore CS0649
    ...
    public event Action<string> haveProjectID;
    ...
    public void OnProjectRoomChanged(ProjectRoom projectRoom)
    {
        ...
        //annot.SelectProject(m_Room.project.projectId);
    }
    ...
    void OnItemButtonClicked()
    {
        ...
        haveProjectID?.Invoke(m_Room.project.projectId);
    }
